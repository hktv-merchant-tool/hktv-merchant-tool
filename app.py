...
CATEGORY_DATA = {
    "超級市場": {
        "gmv佔比": "33.9億港元（佔比 43.0%）",
        "目標客群": "家庭消費者、重複購買率高",
        "物流要求": "常溫/冷藏/急凍",
        "熱門工具": ["GREEN LAB臨期百貨", "會員月費計劃", "個人專屬價"],
        "優勢話術": "超品市場品類是HKTVmall GMV火熱的品類，2025年完成訂單總額達33.9億港元（佔比43.0%），家庭消費者忠誠度高，复購率達4.7x/季。屯門、葵涌、上水等7大貨倉網絡配合350+輛全溫控貨車車隊，加上個人專屬價動態標籤（轉化率約20%），入駐即可享受流量紅利。",
    },
    "護理保健": {
        "gmv佔比": "19.8億港元（佔比 25.1%）",
        "目標客群": "女性消費者、年輕白領、注重健康人士",
        "物流要求": "常溫",
        "熱門工具": ["個人專屬價", "直播頻道", "ChicChat互動工具"],
        "優勢話術": "護理保健產品在HKTVmall增長迅猛，2025年品類GMV達19.8億港元（佔比25.1%），將軍澳總部自動化揀貨及倉存系統每日處理10萬+訂單。配合ChicChat商家直接對話與Sharehub CRM精準劃分52%女性高消費客群，個人專屬價工具精準觸及目標客戶，20%轉化率效果顯著。",
    },
    "護護化妝": {
        "gmv佔比": "19.8億港元（佔比 25.1%）",
        "目標客群": "女性消費者、年輕白領",
        ...
        "優勢話術": "護護化妝品市場高速增長，2025年品類GMV達19.8億港元（佔比25.1%），直播頻道可展示產品實際效果，配合ChicChat與Sharehub CRM精準定位女性消費者。個人專屬價工具精準觸及目標客戶，大幅提升轉化率。",
    },
    "家品傢俬": {
        "gmv佔比": "中",
        "目標客群": "家庭消費者、置業人士",
    ...
    "家居電器": {
        ...
        "優勢話術": "家居電器品類2025年GMV達6.6億港元（佔比8.4%），全港75家O2O門市及460+個線下取貨點提供高價電子產品安心退換貨保障。配合Live Show限時直播購物與Zoom Sales線上真人售貨員即時引流，蘇寧等大型品牌直播單晚GMV近90萬，成效顯著。",
    },
    "運動旅行": {
        "gmv佔比": "中",
        "目標客群": "運動愛好者、旅行人士",
    ...
    "寵物用品": {
        "gmv佔比": "8.6億港元（佔比 10.9%）",
        "目標客群": "寵物主人、家庭客戶",
        "物流要求": "常溫",
        "熱門工具": ["直播頻道", "個人專屬價", "CRM精準廣告"],
        "優勢話術": "寵物市場快速增長，2025年品類GMV達8.6億港元（佔比10.9%），青衣3PL專業物流託管倉庫支援海外集運與最後一哩配送。配合Plus+會員月費計劃低價搶購與「寵物關注組」群組定向爆破行銷，直播頻道展示寵物用品實際使用效果，大幅提升轉化率。",
    },
    "玩具圖書": {
        "gmv佔比": "中",
        "目標客群": "家庭客戶、兒童家長",
...
def generate_pptx_report(merchant_name: str, category: str, selected_pains: list, template_bytes: bytes = None) -> bytes:
    ...
    # 從 CATEGORY_DATA 取出 GMV 敘述（已含 v2.0 精確數字）
    cat_data = CATEGORY_DATA.get(category, {})
    category_gmv = cat_data.get("gmv佔比", "HKTVmall 強勢品類")
    category_tools = "、".join(cat_data.get("熱門工具", [])) if cat_data.get("熱門工具") else ""
    category_pitch = cat_data.get("優勢話術", "")
